...
class SeoController extends Controller
{
    ...
    public function homepage()
    {
        $meta = [
            ...
            'keywords' => 'متجر زواحف, حيوانات أليفة, زواحف, أفاعي, إمدادات زواحف, رعاية حيوانات, السعودية, Reptile House',
            'canonical' => url('/'),
            'robots' => 'index, follow',
    ...
    public function articles()
    {
        $meta = [
            ...
            'twitter:card' => 'summary_large_image',
            'twitter:title' => 'المقالات والمعلومات - Reptile Controller',
    ...
    public function about()
    {
        $meta = [
            ...
            'description' => 'تعرف على Reptile House، متجركمكم الأول للزواحف والحيوانات الأليفة في السعودية. نقدم منتجات عالية الجودة وخدمات رعاية موثوقة.',
            'keywords' => 'من نحن, Reptile House, عن المتجر, زواحف, حيوانات, السعودية',
            'canonical' => url('/about'),
            'robots' => 'index, follow',
            'og:title' => 'من نحن - Reptile House',
            'og:description' => 'تعرف على Reptile House، متجركمكم الأول للزواحف والحيوانات الأليفة في السعودية. نقدم منتجات عالية الجودة وخدمات رعاية موثوقة.',
            'og:type' => 'website',
            'og:url' => url('/about'),
            'og:image' => asset('images/og-about.jpg'),
            'twitter:card' => 'summary_large_image',
            'twitter:title' => 'من نحن - Reptile House',
            'twitter:description' => 'تعرف على Reptile House، متجركمكم الأول للزواحف والحيوانات الأليفة في السعودية. نقدم منتجات عالية الجودة وخدمات رعاية موثوقة.',
    ...
    public function contact()
    {
        $meta = [
            ...
            'twitter:description' => 'تواصل مع فريق Reptile House للاستفسار عن المنتجات أو طلب المساعدة في رعاية حيواناتك الأليفة. رقم الهاتف والبريد الإلكتروني.',
